...
#%%
html_banner = '''
<div id="maptitle" style="position: fixed; top: 10px; left: 10px; width: 360px; z-index: 9999; font-size: 12px; border-radius: 5px; color: black; background-color: white; padding: 5px; box-shadow: 0 0 10px rgba(0,0,0,0.3);">
